# -*- coding: utf-8 -*-
#
# defmain documentation build configuration file, created by
...
latex_documents = [
  ('index', 'defmain.tex', u'defmain Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'defmain', u'defmain Documentation',
     [u''], 1)
]
